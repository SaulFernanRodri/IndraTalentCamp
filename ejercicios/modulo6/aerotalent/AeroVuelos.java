...
public class AeroVuelos {
    ...
    public void mostrarVuelosDisponibles(){
        ...
        JOptionPane.showMessageDialog(null, !sb.isEmpty() ? sb.toString() : "No hay vuelos disponibles.");
    }
    ...
    public void mostrarReservar(){
        ...
        JOptionPane.showMessageDialog(null, !sb.isEmpty() ? sb.toString() : "No hay reservar realizadas.");
    }
